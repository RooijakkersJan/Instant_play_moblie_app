...
public class AlaramAdapter extends BaseAdapter {
    ...
    public AlaramAdapter(Context context, ArrayList<Songs> SongsModal) {
   ...
   /* @Override
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textview1.setText(modal.gettext());
        ...
        if(modal.getPlaylistCat().equals("Ads"))
        {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                    0, LinearLayout.LayoutParams.WRAP_CONTENT,0.75f);
            holder.l1.setLayoutParams(params);
      ...
      /*  holder.chk.setChecked(SongsModal.get(position).getSelected());
        ...
        holder.img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ((HomeActivity)context).instanttxt(position);
        ...
        holder.img3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
               // ((HomeActivity)context).instantstopAlarm(position,SongsModal.get(position).getCheckvalue(),"Stop");
